...
class ClientPrefs {
	...
	public static function saveSettings() {
		...
		save.bind('controls_v2', 'speedygif'); //Placing this in a separate save so that it can be manually deleted without removing your Score and stuff
	...
	public static function loadPrefs() {
		...
		var save:FlxSave = new FlxSave();
		save.bind('controls_v2', 'speedygif');
